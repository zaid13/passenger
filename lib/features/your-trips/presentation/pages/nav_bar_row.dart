  ...
  return Row(
    ...
    children: [
      FlatButton(
        ...
        child: Column(
          children: [
            ...
            Text('Today',style: GoogleFonts.poppins(color: Mycolor.electricBlue,fontSize: 12,fontWeight: FontWeight.bold),),
      ...
      FlatButton(
        ...
        child: Column(
          children: [
            Text('Weekly',style: GoogleFonts.poppins(color: Mycolor.h1color,fontSize: 12,fontWeight: FontWeight.bold),),
            Container(height: 10,),
   ...
   return Row(
     ...
     children: [
       FlatButton(
         ...
         child: Column(
           children: [
             ...
             Text('Today',style: GoogleFonts.poppins(color: Mycolor.h1color,fontSize: 12,fontWeight: FontWeight.bold),),
       ...
       FlatButton(
         ...
         child: Column(
           children: [
             Text('Weekly',style: GoogleFonts.poppins(color: Mycolor.electricBlue,fontSize: 12,fontWeight: FontWeight.bold),),
             Container(height: 10,),
