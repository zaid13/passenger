...
enum PaymntScreen_School{
 personal,
  business

}

enum PaymntOptinon_School{
  visa,
  paypal,
  cash
...
class Schoool_payment extends StatefulWidget {
  @override
  _Schoool_paymentState createState() => _Schoool_paymentState();
}

class _Schoool_paymentState extends State<Schoool_payment> {
  ...
  PaymntScreen_School pl =  PaymntScreen_School.personal;
  PaymntOptinon_School paymntOptinon_School   =PaymntOptinon_School.paypal;
  ...
  _PaymentOptionTile(){
    return Column(children: [
      ...
      _optionTile(PaymntOptinon_School.visa,paymntOptinon_School== PaymntOptinon_School.visa,'assets/ui/vehicles/visa.png','VISA','123*******'),
      _optionTile(PaymntOptinon_School.paypal,paymntOptinon_School== PaymntOptinon_School.paypal, 'assets/ui/vehicles/paypal.png','Paypal','john@msn.com'),
      _optionTile(PaymntOptinon_School.cash,paymntOptinon_School== PaymntOptinon_School.cash,'assets/ui/vehicles/denominnation.png','Cash',''),
  ...
  _optionTile(po , istrue,img,upperheading,lowerheading){
    return Padding(
      ...
      child: FlatButton(
        onPressed: (){
          print(po);
          print(paymntOptinon_School);
          setState(() {
            paymntOptinon_School = po;
  ...
  _Business_personal_Tab(paymntScreen_School,fun){
    if(paymntScreen_School==PaymntScreen_School.business)
      {
        return Row(
