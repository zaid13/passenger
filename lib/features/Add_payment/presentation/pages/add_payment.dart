...
class _Add_PaymentState extends State<Add_Payment> {
  ...
  PaymntOptinon paymntOptinon   =PaymntOptinon.visa;
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        ...
                        if(pl == PaymntScreen.business){
                          pl = PaymntScreen.personal;
                        }else{
                          pl = PaymntScreen.business;
  ...
  _PaymentOptionTile(){
    return Column(children: [
      ...
      _optionTile(paymntOptinon== PaymntOptinon.visa,'assets/ui/vehicles/visa.png','VISA','123*******'),
      _optionTile(paymntOptinon== PaymntOptinon.paypal, 'assets/ui/vehicles/paypal.png','Paypal','john@msn.com'),
      _optionTile(paymntOptinon== PaymntOptinon.cash,'assets/ui/vehicles/denominnation.png','Cash',''),
