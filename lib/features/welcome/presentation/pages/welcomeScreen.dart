...
Container(
  height: 10,
              ...
              Common_Widgets_Class.getMasterHeadingWithUpperSubHeading('Get a new experience','Hello, nice to meet you!'),
...
width: MediaQuery.of(context).size.width,
            ...
            child: Image.asset('assets/ui/welcome_screen_crousal/'+item.toString()+'.png',
              height: MediaQuery.of(context).size.width,
              width: MediaQuery.of(context).size.width,
fit: BoxFit.cover,
            ),
        ...
        Container(
          ...
          itemBuilder: (context, index) {
            return currindex!=index? Icon(Icons.circle,color: Colors.black12,size: 15,):Icon(Icons.circle,color: Mycolor.electricBlue,size: 15);
