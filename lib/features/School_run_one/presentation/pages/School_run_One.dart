...
class Schoold_run extends StatefulWidget {
  @override
  _Schoold_runState createState() => _Schoold_runState();
}

class _Schoold_runState extends State<Schoold_run> {
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                   Column(
                     children: [
                       _getFromToTripTile('Beaconhouse School','elonmusk@gmail.com','John Doe','+92 900 78601','School Name','Country Mail','Account Name','Parents Contact Number'),
                      ...
                      Container(height: 20,),
                       _CurvedBigBlueButton('Set Up Business',(){
                         Navigator.push(
                             context,
                             MaterialPageRoute(
                               builder: (context) =>School_run_two() ,
                             ));
                       }),
                     ],
                   ),
...
_getFromToTripTile(String from, String middle ,String to,String extremelast,  String one,String two ,String three,String four ){
return Material(
  elevation: 20,
        ...
        Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Icon(Icons.circle,color: Mycolor.electricBlue,size: 10,),

              Padding(
                padding: const EdgeInsets.all(3.0),
                child: Icon(Icons.circle,color: Mycolor.h1color.withOpacity(0.2),size: 3,),
              ),
