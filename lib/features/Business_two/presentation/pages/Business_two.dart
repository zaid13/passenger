...
class Business_two extends StatefulWidget {
  @override
  _Business_twoState createState() => _Business_twoState();
}

class _Business_twoState extends State<Business_two> {
  ...
  void initState() {
    ...
    teamNameCtrl.addListener(() {
      setState(() {
        ...
        teamisokay = teamNameCtrl.text.isNotEmpty;

      });

    });
    businessEmailCtrl.addListener(() {
setState(() {
  businessEmailisokay =businessEmailCtrl.text.isNotEmpty  ;
      ...
      child:   Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _getTextField(teamNameCtrl,  TextInputType.text ,teamisokay,(){}, 'Team Name'),
            _getTextField(businessEmailCtrl,  TextInputType.text ,businessEmailisokay,(){}, 'Business Email')
