        ...
        child: Scaffold(
          ...
          body: Container(
            ...
            child: ListView(
              ...
              children: [
                Common_Widgets_Class.Topbar(context,(){Navigator.pop(context);},'LEGAL'),
                Container(
                  height: 20,
                ),
                Padding(
                  padding: const EdgeInsets.only(right: 15,left: 15),
                  child: Text(TermsScreenHeading,style: GoogleFonts.poppins(color: Mycolor.h1color.withOpacity(0.6),fontSize: 12,fontWeight: FontWeight.normal),),
                ),


                Padding(
                  padding: const EdgeInsets.only(right: 15,left: 15),
                  child: Text(TermsSiginUpString,style: GoogleFonts.poppins(color: Mycolor.h1color,fontSize: 14,fontWeight: FontWeight.normal),),
                ),
