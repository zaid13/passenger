...
enum PaymntScreen_payment{
 personal,
  business

}

enum PaymntOptinon_payment{
  visa,
  paypal,
  cash
...
class PaymentState extends State<Payment> {
  ...
  PaymntScreen_payment pl =  PaymntScreen_payment.personal;
  PaymntOptinon_payment paymntOptinon_payment   =PaymntOptinon_payment.visa;
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Column(
                      children: [
                        _Business_personal_Tab(pl,(){setState(() {
                        if(pl == PaymntScreen_payment.business){
                          pl = PaymntScreen_payment.personal;
                        }else{
                          pl = PaymntScreen_payment.business;

                        }
                      });} ),
                Container(height: 15,),
                      Container( width: MediaQuery.of(context).size.width * 0.8,height: 1,color: Mycolor.h1color.withOpacity(0.5),),
                        _PaymentOptionTile()
                      ],
                    ...
                    _BigBlueButton('Done',(){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => Write_Bank_Card(),));
  ...
  _PaymentOptionTile(){
    return Column(children: [
      ...
      _optionTile(paymntOptinon_payment== PaymntOptinon_payment.visa,'assets/ui/vehicles/visa.png','VISA','123*******'),
      _optionTile(paymntOptinon_payment== PaymntOptinon_payment.paypal, 'assets/ui/vehicles/paypal.png','Paypal','john@msn.com'),
      _optionTile(paymntOptinon_payment== PaymntOptinon_payment.cash,'assets/ui/vehicles/denominnation.png','Cash',''),
  ...
  _Business_personal_Tab(paymntScreen_payment,fun){
    if(paymntScreen_payment==PaymntScreen_payment.business)
      {
        return Row(
