...
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
  ...
  class School_run_two extends StatefulWidget {
  @override
  _School_run_twoState createState() => _School_run_twoState();
}

class _School_run_twoState extends State<School_run_two> {
  ...
  TextEditingController schoolAddressCtrl =  TextEditingController();
  TextEditingController startTimeCtrl =   TextEditingController();
  TextEditingController endTimeCtrl =  TextEditingController();


  bool teamisokay = false;
  bool businessEmailisokay = false;


  bool startTImeisokay = false;
  bool endTimeisokay = false;

  @override
  void initState() {
    // TODO: implement initState

    schoolNameCtrl.addListener(() {
      setState(() {

        teamisokay = schoolNameCtrl.text.isNotEmpty;

      });

    });
    schoolAddressCtrl.addListener(() {
setState(() {
  businessEmailisokay =schoolAddressCtrl.text.isNotEmpty  ;

});

    });
    startTimeCtrl.addListener(() {
setState(() {
  startTImeisokay = startTimeCtrl.text.isNotEmpty;
});

    });
    endTimeCtrl.addListener(() {
      setState(() {
        endTimeisokay =endTimeCtrl.text.isNotEmpty;
            ...
            Positioned(
              child: Padding(
                ...
                child: ListView(
                  ...
                  children: [
                    _getFromToTripTile('Centaurus Mall','FAST NUCES Islamabad','Tean Name','Business Email'),

                 Container(height: 20,),
                    _buttonText('By continuing, I confirm that i have read & agree to the',' Terms of Service',' and ','Privacy Policy',(){}),
                    Container(height: 10,),

                    _CurvedBigBlueButton('Next',(){

                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) =>School_run_three() ,
                          ));
                    }),
...
_getFromToTripTile(String from, String to,String one, String two){
return Material(
  elevation: 20,
      ...
      child:   Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _getTextField(schoolNameCtrl,  TextInputType.text ,teamisokay,(){}, 'School Name'),
            _getTextField(schoolAddressCtrl,  TextInputType.text ,businessEmailisokay,(){}, 'School Address'),
            _getTextField(startTimeCtrl,  TextInputType.datetime ,startTImeisokay,(){}, 'School Start Time'),
            _getTextField(endTimeCtrl,  TextInputType.datetime ,endTimeisokay,(){}, 'School End Time')
...
mainAxisAlignment: MainAxisAlignment.start,
  ...
  _getTextField(TextEditingController ctrl,  TextInputType tctip,isvisible,codeNumberFun,lble){
      ...
      child: TextField(
        ...
        keyboardType: tctip,
          decoration: InputDecoration(
            labelText: lble,
              labelStyle: GoogleFonts.poppins(color: Mycolor.h1color,fontSize: 14,fontWeight: FontWeight.normal),

              suffixIcon: isvisible?Padding(
  padding: const EdgeInsets.only(bottom: 10),
  child:   Icon(Icons.check_circle_rounded,color: Mycolor.primaryColor, size: 18,),
):Container(
                height: 0,
                width: 0,
              ),
