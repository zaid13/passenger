...
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:passenger/features/School_Payment/presentation/pages/School_Payment.dart';

class School_run_three extends StatefulWidget {
  @override
  _School_run_threeState createState() => _School_run_threeState();
}

class _School_run_threeState extends State<School_run_three> {
  ...
  TextEditingController councilEmailCtrl =   TextEditingController();
  TextEditingController Account_nameCtrl =  TextEditingController();
  ...
  void initState() {
    ...
    councilEmailCtrl.addListener(() {
      setState(() {

        teamisokay = councilEmailCtrl.text.isNotEmpty;

      });

    });
    Account_nameCtrl.addListener(() {
setState(() {
  businessEmailisokay =Account_nameCtrl.text.isNotEmpty  ;

});

    });
    authCodeCtrl.addListener(() {
setState(() {
  startTImeisokay = authCodeCtrl.text.isNotEmpty;
});
                 ...
                 Container(height: 20,),
                    ...
                    _CurvedBigBlueButton('Next',(){
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) =>Schoool_payment() ,
                          ));
      ...
      child:   Container(
        ...
        child: Column(
          ...
          children: [
            ...
            _getTextField(councilEmailCtrl,  TextInputType.text ,teamisokay,(){}, 'Counic Email'),
            _getTextField(Account_nameCtrl,  TextInputType.text ,businessEmailisokay,(){}, 'Account Name'),
            _getTextField(authCodeCtrl,  TextInputType.datetime ,startTImeisokay,(){}, 'Authorization Code'),
