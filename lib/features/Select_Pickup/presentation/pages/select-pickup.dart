...
import 'package:passenger/features/select-car-2/presentation/pages/select_car_2.dart';
...
class Select_Pickup extends StatefulWidget {
  @override
  _SelectPickUpState createState() => _SelectPickUpState();
}

class _SelectPickUpState extends State<Select_Pickup> {
...
Column(
  children: [
    ...
    Container(height: 10,),
    _IconTextTile(Icons.home_outlined ,'Home'),
    ...
    FlatButton(
      ...
      child:     _IconTextTile(Icons.pin_drop_outlined ,'PIN Location'),
                    ...
                    _CurvedBigBlueButton('Accept',(){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => SelectCar_2(),));
