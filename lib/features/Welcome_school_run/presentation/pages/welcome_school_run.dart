...
class Welcome_School_run extends StatefulWidget {
  @override
  _Welcome_School_runState createState() => _Welcome_School_runState();
}

class _Welcome_School_runState extends State<Welcome_School_run> {
          ...
          child: ListView(
            ...
            children: [
              ...
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Common_Widgets_Class.getMasterHeadingWithUpperSubHeading('To School Run','Welcome'),
                  _getSubTitle()
